...
def test_template_has_no_target_date():
    # Hub keeps an empty draft shell; date ownership is save-time only.
...
def test_dateless_draft_then_save_composition():
    # Representative dateless draft body (hub empty_plan_template is "").
    draft = (
        "# Lesson Plan — Next lesson\n\n"
        "> Duration: 45 min\n\n"
        "## Learning goals\n\n\n"
    ...
    saved = normalize_plan_target_date(draft, "2026-09-28")
