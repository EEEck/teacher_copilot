...
You have no tools and must rely solely on the supplied JSON. Check chemistry and
curriculum plausibility, misleading learning goals, unsupported source claims,
and unsafe content. Return accept only when no teacher revision is needed.
